...
class Dashboard:
    ...
    def _get_settings(self):
        ...
        return {
            ...
            "alert_min_entry_roi_pct": float(self.config.get("alert_min_entry_roi_pct", 12) or 0),
            "alert_priority_enabled": self.config.get("alert_priority_enabled", True),
            "alert_priority_high_min_roi_pct": float(self.config.get("alert_priority_high_min_roi_pct", 25) or 25),
            "alert_priority_medium_min_roi_pct": float(self.config.get("alert_priority_medium_min_roi_pct", 15) or 15),
            "alert_priority_insider_bump": self.config.get("alert_priority_insider_bump", True),
